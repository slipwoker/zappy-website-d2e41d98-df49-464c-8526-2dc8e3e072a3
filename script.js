document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const successMessage = contactForm.getAttribute('data-success-message') || 'Thank you! Your message has been sent successfully.';
      ...
      fetch(action, {
        ...
        .then(function (response) {
          if (response.ok) {
            showFormFeedback(contactForm, successMessage, 'success');
            contactForm.reset();
            fields.forEach(function (field) {
              field.classList.remove('field-success', 'field-error');
            });
          } else {
            showFormFeedback(contactForm, errorMessage, 'error');
          }
        })
        .catch(function () {
          showFormFeedback(contactForm, errorMessage, 'error');
    ...
    const showFormFeedback = function (form, message, type) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Nataly Visberg Art Studio משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd2e41d98-df49-464c-8526-2dc8e3e072a3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd2e41d98-df49-464c-8526-2dc8e3e072a3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd2e41d98-df49-464c-8526-2dc8e3e072a3';
